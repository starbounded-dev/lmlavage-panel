...
export default async function ExpensesPage() {
  ...
  return (
    <>
      <PageHeader title="Dépenses" description="Dépenses d’entreprise, taxes et reçus justificatifs." action={<NewExpenseDialog jobs={data.jobs} business={data.business} workers={data.workers} />} />
